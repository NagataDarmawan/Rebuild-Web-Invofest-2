    ...
    <div className="px-7 py-8 max-w-5xl mx-auto font-sans">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Kelola dan pantau semua daftar pembicara</p>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-10 text-center">
        <p className="text-gray-400 text-sm">Daftar pembicara akan muncul di sini.</p>
      </div>
